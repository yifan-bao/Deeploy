# ----------------------------------------------------------------------
#
# File: MatMulTileConstraintFlow.py
#
...
class MatMulTileConstraintFlow(TileConstraintFlow):
    ...
    def serializeTilingSolution(cls, tilingSolution: NodeMemoryConstraint, outputCubes: List[HyperRectangle],
        ...
        replacementTypes = {
            "M": Pointer(IntegerDataTypes.int8_t),
            "N": Pointer(IntegerDataTypes.int8_t),
            "O": Pointer(IntegerDataTypes.int8_t),
            "batch": Pointer(IntegerDataTypes.int8_t)
        }
