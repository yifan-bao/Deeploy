# ----------------------------------------------------------------------
#
# File: iSoftmaxTileConstraintFlow.py
#
...
class iSoftmaxTileConstraintFlow(TileConstraintFlow):
    ...
    def serializeTilingSolution(cls, tilingSolution: NodeMemoryConstraint, outputCubes: List[HyperRectangle],
        ...
        replacementTypes = {
            "lastDimLength": Pointer(IntegerDataTypes.uint32_t),
            "size": Pointer(IntegerDataTypes.uint32_t)
        }
