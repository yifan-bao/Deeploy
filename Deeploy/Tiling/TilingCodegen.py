...
from Deeploy.Tiling.MemoryConstraints import MemoryConstraint, NodeMemoryConstraint
...
class VariableReplacementScheme():
    ...
    replacementTypes: Dict[str, Type[PointerClass]]

    def __init__(self, perTileReplacements: Dict[str, List], replacementTypes: Dict[str, Type[PointerClass]]):
