...
from Deeploy.AbstractDataTypes import HelperTypes, Pointer, Struct
...
class ClosureGeneration(CodeTransformationPass, IntrospectiveCodeTransformationMixIn):
    ...
    def __init__(self,
        ...
        self.closureTemplate = copy.deepcopy(_closureTemplate)
        self.closureCallTemplate = copy.deepcopy(closureCallTemplate)
        self.closureStructDefTemplate = copy.deepcopy(_closureStructDefTemplate)
        self.closureWriteBackTemplate = copy.deepcopy(_closureWriteBackTemplate)
        self.closureStructArgs: Optional[Dict] = None
    ...
    def _generateClosureStruct(self, ctxt: NetworkContext, executionBlock: ExecutionBlock):
        ...
        # Add closure struct info to nodeRep
        ...
        for arg in list(dict.fromkeys(makoDynamicReferences)):
            ...
            if isinstance(ref, TransientBuffer):
                closureStructArgsType[ctxt._mangle(arg)] = Pointer(HelperTypes.void)
        ...
        self.closureStructArgType = Struct(self.closureName + "_args_t", closureStructArgsType)
    ...
    def _generateClosureCall(self, ctxt: NetworkContext, executionBlock: ExecutionBlock,
        ...
        if self.generateStruct:
            ctxt, executionBlock = ArgumentStructGeneration().apply(ctxt, executionBlock, nodeName)
