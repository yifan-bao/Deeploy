...
from Deeploy.DeeployTypes import CodeTransformationPass, ConstantBuffer, ExecutionBlock, NetworkContext, StructBuffer, \
    TransientBuffer
    ...
    def apply(self, ctxt: NetworkContext, executionBlock: ExecutionBlock,
        ...
        for _buffer in buffers:
            if isinstance(_buffer, StructBuffer) and name in _buffer._users:
                executionBlock.addLeft(_buffer.allocTemplate, _buffer._nodeRep())
                executionBlock.addLeft(_buffer.initTemplate, _buffer._nodeRep())
...
class MemoryManagementGeneration(CodeTransformationPass, IntrospectiveCodeTransformationMixIn):
    ...
    def apply(self, ctxt: NetworkContext, executionBlock: ExecutionBlock,
        ...
        for buffer in list(reversed(outputNames)) + transientBuffers:
            ...
            executionBlock.addLeft(nb.allocTemplate, nb._nodeRep())
        ...
        for buffer in inputNames + transientBuffers:
            ...
            executionBlock.addRight(nb.deallocTemplate, nb._nodeRep())
