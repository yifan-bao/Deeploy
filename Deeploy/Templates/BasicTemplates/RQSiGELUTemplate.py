...
// RequantizediGELU (Name: ${node_name}, Op: ${node_op})
SINGLE_CORE RQGELU_s${data_in_type._value_}_s${data_in_type._value_}(${data_in}, ${data_out}, ${size}, ${b}, ${one}, ${input_offset}, ${output_offset}, ${mul}, ${add}, ${shift});
""")
