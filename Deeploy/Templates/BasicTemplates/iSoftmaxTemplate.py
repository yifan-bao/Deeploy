...
// iSoftmax (Name: ${node_name}, Op: ${node_op})
SINGLE_CORE Softmax_s${data_in_type._value_}_s${data_out_type._value_}(${data_in}, ${data_out}, ${size}, ${lastDimLength}, ${coeffA}, ${coeffB}, ${coeffC}, ${log2}, ${n_levels});
""")
