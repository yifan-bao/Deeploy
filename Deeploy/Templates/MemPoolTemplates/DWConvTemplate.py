...
// 1D Depth-Wise Conv Parallel (Name: ${node_name}, Op: ${node_op})
...
for (uint32_t n=0; n<${batch}; ++n) {
    DWConv2d_parallel_s${data_in_type._value_}_NCHW(
...
// 2D Depth-Wise Conv Parallel (Name: ${node_name}, Op: ${node_op})
mempool_barrier(numThreads);
${data_in_type._name_}* ref_${data_out}_${data_in} = ${data_in};
${data_out_type._name_}* ref_${data_out}_${data_out} = ${data_out};
