...
class _MHSATemplate(NodeTemplate):
    ...
    def alignToContext(self, ctxt: NetworkContext, nodeRep: Dict) -> Tuple[NetworkContext, Dict, List[str]]:
        ...
        # Q FC layer:
        ctxt, nodeRep = bindFCParams(ctxt,
                                     nodeRep['data_out'] + "_wq",
                                     nodeRep['wq_requant_mul'],
                                     nodeRep['wq_requant_shift'],
                                     data_in,
                                     weight,
                                     nodeRep,
                                     "wq_",
        ...
        ctxt, nodeRep = bindFCParams(ctxt,
                                     nodeRep['data_out'] + "_wk",
                                     nodeRep['wk_requant_mul'],
                                     nodeRep['wk_requant_shift'],
                                     data_in,
                                     weight,
                                     nodeRep,
                                     "wk_",
        ...
        ctxt, nodeRep = bindFCParams(ctxt,
                                     nodeRep['data_out'] + "_wv",
                                     nodeRep['wv_requant_mul'],
                                     nodeRep['wv_requant_shift'],
                                     data_in,
                                     weight,
                                     nodeRep,
                                     "wv_",
        ...
        ctxt, nodeRep = bindFCParams(ctxt,
                                     nodeRep['data_out'] + "_wo",
                                     nodeRep['wo_requant_mul'],
                                     nodeRep['wo_requant_shift'],
                                     data_in,
                                     weight,
                                     nodeRep,
                                     "wo_",
        ...
        ctxt, nodeRep = bindFCParams(ctxt,
                                     nodeRep['data_out'] + "_preattn",
                                     nodeRep['preattn_requant_mul'],
                                     nodeRep['preattn_requant_shift'],
                                     data_in,
                                     weight,
                                     nodeRep,
                                     "preattn_",
        ...
        ctxt, nodeRep = bindFCParams(ctxt,
                                     nodeRep['data_out'] + "_postattn",
                                     nodeRep['postattn_requant_mul'],
                                     nodeRep['postattn_requant_shift'],
                                     data_in,
                                     weight,
                                     nodeRep,
                                     "postattn_",
