...
%>
void* _Deeploy__ctxtBuffer_${ctxt} = deeploy_malloc(sizeof(int8_t)*${ctxt}.size);
${ctxt}.buf = _Deeploy__ctxtBuffer_${ctxt};
...
free(_Deeploy__ctxtBuffer_${ctxt});
""")
...
%>
void* _Deeploy__ctxtBuffer_${ctxt} = deeploy_malloc(sizeof(int16_t)*${ctxt}.size);
${ctxt}.buf = _Deeploy__ctxtBuffer_${ctxt};
for(int b=0; b<${batch}; b++){
